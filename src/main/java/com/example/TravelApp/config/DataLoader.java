...
public class DataLoader implements CommandLineRunner {
    ...
    public DataLoader(UserService userService, DestinationService destinationService, TourPackageService tourPackageService) {
    ...
    public void run(String... args) {
        ...
        if (destinationService.findAll().isEmpty()) {
            ...
            // --- Beach Side Packages ---
            tourPackageService.save(new TourPackage("Mirissa Whale Watching", "4-day exciting beach vacation with a whale watching cruise.", 180.0, 4.7, "/images/Mirssa.jpa.jpeg", "Beach", 12, mirissa));
            ...
            tourPackageService.save(new TourPackage("Kandy Dalada Maligawa Heritage", "2-day blessed cultural visit to the sacred tooth relic temple.", 175.0, 4.9, "/images/Kandy.jpa.png", "Cultural", 30, mahanuwara));
        }
    }
}